...
/*
  ...
  2. Завершит работу, если будет введена пустая строка, либо "Отмена";
...
arr.splice(3, 0, 'Nik', 'Devid', 'Morgan'); 
...
// Метод concat объединяет несколько массивов в один

arr.forEach(function(item, index, array) {
  console.log(`${index + 1} элемент массива ${array}: ${item}`);
})

// Метод forEach переберает элементы массива и выполняет, указанные нам действия
...
// Переберает массив и создает новый, с результатами действий, которые мы определили
